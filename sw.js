...
self.addEventListener('fetch',e=>{
  ...
  if(u.origin===location.origin){
    const freshAsset=u.pathname.endsWith('/site-navigation-v2.js')||u.pathname.endsWith('/site-pages.css')||u.pathname.endsWith('/site-luxe.css')||u.pathname.endsWith('/site-atelier-v47.css')||u.pathname.endsWith('/site-cinematic-v48.css')||u.pathname.endsWith('/site-editorial-v49.css')||u.pathname.endsWith('/site-hide-ev-v50.css');
    if(freshAsset){
